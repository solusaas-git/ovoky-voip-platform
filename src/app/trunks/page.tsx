...
export default function UserTrunksPage() {
  ...
  return (
    <MainLayout>
      <PageLayout
        title="My Trunks"
        description="View your assigned SIP trunks and their configuration"
        breadcrumbs={[
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">SIP Registration</CardTitle>
            <Settings className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-green-600">Check Table</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-600">Check Table</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Search Trunks</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Your Trunks ({trunks.length})</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No trunks assigned</h3>
              <p className="text-muted-foreground">
                You don't have any SIP trunks assigned to your account yet.
              </p>
            </div>
          ) : (
            <Table>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end space-x-1">
                        ...
                        <Button
                          ...
                          title="View authentication rules (read-only)"
                        >
