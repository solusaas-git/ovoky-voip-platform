        ...
        <TabsContent value="company">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Business details from your onboarding</CardDescription>
            </CardHeader>
            <CardContent>
              {onboardingData ? (
                <div className="grid gap-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-sm font-medium text-muted-foreground">Business Phone</h3>
                  ...
                  {onboardingData.trafficVolume && (
                    <>
                      <Separator />
                      <div className="space-y-2">
                        <h3 className="text-sm font-medium text-muted-foreground">Expected Traffic Volume</h3>
                        <div className="flex items-center gap-2">
                          <BarChart3 className="h-4 w-4 text-muted-foreground" />
                          <p>
                            {onboardingData.trafficVolume.value.toLocaleString()} {onboardingData.trafficVolume.unit} per {onboardingData.trafficVolume.period}
                          </p>
                        </div>
                      </div>
                    </>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Complete your onboarding to add company details
                  </p>
            ...
            <CardContent>
              {onboardingData?.preferredContactMethods?.length ? (
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-medium mb-2">No Contact Preferences</h3>
                  <p className="text-muted-foreground">
                    No contact methods have been configured
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="services">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Services you&apos;re interested in or currently using</CardDescription>
            </CardHeader>
            <CardContent>
              {onboardingData?.servicesInterested?.length ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">
                    No services have been selected during onboarding
                  </p>
                </div>
              )}
            </CardContent>
