        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-semibold" style={{ color: colors.primary }}>
              Loading Number Rate Decks
            </h3>
            <p className="text-muted-foreground">Fetching number rate decks...</p>
          </div>
        </div>
      </div>
    );
      ...
      <Card className="border-destructive">
        <CardHeader>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <CardTitle className="text-destructive">Error Loading Number Rate Decks</CardTitle>
              <CardDescription>There was an error loading the number rate decks data</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
            ...
            <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handleFormSubmit}>
                  <DialogHeader>
                    <DialogTitle>
                      {editingRateDeck ? 'Edit Number Rate Deck' : 'Create Number Rate Deck'}
                    </DialogTitle>
                    <DialogDescription>
                      {editingRateDeck ? 'Update the rate deck details.' : 'Create a new number rate deck.'}
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Input
                        ...
                        placeholder="e.g., Premium Rates, Standard Rates"
                        required
                      />
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Textarea
                        ...
                        className="col-span-3"
                        placeholder="Describe this rate deck..."
                        rows={3}
                      />
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <DialogFooter>
                    <Button type="submit" style={{ backgroundColor: colors.primary }}>
                      {editingRateDeck ? 'Update Rate Deck' : 'Create Rate Deck'}
                    </Button>
                  </DialogFooter>
                </form>
              </DialogContent>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Total Rate Decks</p>
        ...
        <Card>
          <CardContent className="text-center py-12">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold" style={{ color: colors.primary }}>
                  No Number Rate Decks Found
                </h3>
                <p className="text-muted-foreground">
                  {isAdmin 
                    ? "No number rate decks configured yet. Click 'Create Rate Deck' to create your first rate deck."
                    : "No number rate decks available at the moment. Please contact your administrator."
                  }
                </p>
              </div>
            </div>
