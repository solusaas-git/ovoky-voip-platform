        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-semibold" style={{ color: colors.primary }}>
              Loading SMS Rate Decks
            </h3>
            <p className="text-muted-foreground">Fetching SMS rate decks...</p>
          </div>
        </div>
      </div>
    );
      ...
      <Card className="border-destructive">
        <CardHeader>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <CardTitle className="text-destructive">Error Loading SMS Rate Decks</CardTitle>
              <CardDescription>There was an error loading the SMS rate decks data</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Input
                        ...
                        placeholder="e.g., Premium SMS, Standard SMS"
                        required
                      />
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Textarea
                        ...
                        className="col-span-3"
                        placeholder="Describe this SMS rate deck..."
                        rows={3}
                      />
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
        ...
        <Card>
          <CardContent className="text-center py-12">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold" style={{ color: colors.primary }}>
                  No SMS Rate Decks Found
                </h3>
                <p className="text-muted-foreground">
                  {isAdmin 
                    ? "No SMS rate decks configured yet. Click 'Create Rate Deck' to create your first rate deck."
                    : "No SMS rate decks available at the moment. Please contact your administrator."
                  }
                </p>
              </div>
            </div>
